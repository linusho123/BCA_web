 ...
 *
 * The settings are cleared too, and that is the part worth explaining. Anything chosen for one
 * plate — a procedure, a fit model, which end of the row the standards start at, a dilution
 * factor entered for a batch that was diluted further by hand — is wrong for the next plate by
 * default rather than right. Left behind, a dilution factor of 2 would halve every concentration
